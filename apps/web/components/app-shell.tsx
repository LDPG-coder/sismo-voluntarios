  ...
  return (
    <div className="flex min-h-screen bg-[#f4f5f7] dark:bg-[#0c0b0a]">
      ...
      <div className="flex min-w-0 flex-1 flex-col shadow-[-10px_0_24px_-12px_rgba(15,23,42,0.12)] dark:shadow-[-10px_0_24px_-12px_rgba(0,0,0,0.5)]">
        <header className="sticky top-0 z-30 flex items-center justify-between border-b border-slate-200/70 bg-[#f4f5f7]/80 px-4 py-2 backdrop-blur dark:border-slate-800/70 dark:bg-[#0c0b0a]/80 lg:hidden">
          <button
            type="button"

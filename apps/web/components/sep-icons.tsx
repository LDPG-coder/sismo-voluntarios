...
export function SepWorkshopIcon() {
  return (
    <svg
...
export function SepVolunteerIcon() {
  return (
    <svg
      fill="currentColor"
      version="1.1"
        ...
        <g>
          ...
          <g>
            ...
            <g>
              ...
              <path d="M65.87,121.352c-0.763,0-1.538-0.136-2.294-0.421c-3.358-1.268-5.054-5.018-3.787-8.376 c2.805-7.434,5.827-16.579,6.66-20.561c-2.797-2.67-9.536-8.242-15.298-12.741c-2.83-2.21-3.332-6.294-1.123-9.124 c2.21-2.828,6.295-3.33,9.124-1.122c17.609,13.751,19.027,16.47,19.633,17.63c1.21,2.32,2.716,5.208-6.833,30.508 C70.969,119.747,68.497,121.352,65.87,121.352z"></path>{' '}
              <circle cx="76.713" cy="14.166" r="14.166"></circle>{' '}
              <g>
                {' '}
              ...
              <path d="M28.649,50.542c-1.12,0-2.25-0.34-3.225-1.048c-2.458-1.783-3.006-5.22-1.224-7.679 c2.7-3.724,9.596-12.598,15.307-14.555c5.321-1.824,21.093-0.901,25.8-0.575c3.03,0.21,5.316,2.836,5.106,5.867 c-0.209,3.029-2.805,5.313-5.866,5.107c-8.536-0.589-19.204-0.728-21.479,0.009c-1.657,0.663-6.417,5.722-9.963,10.605 C32.029,49.755,30.351,50.542,28.649,50.542z"></path>{' '}
              <path d="M85.548,44.799c-5.263,0-10.754-0.317-13.907-0.536c-3.03-0.21-5.316-2.836-5.106-5.867 c0.209-3.029,2.8-5.319,5.866-5.107c8.536,0.591,19.204,0.728,21.478-0.009c1.666-0.666,6.426-5.725,9.964-10.604 c1.784-2.458,5.222-3.007,7.682-1.224c2.459,1.783,3.007,5.222,1.225,7.681c-2.7,3.724-9.597,12.597-15.308,14.554 C94.971,44.535,90.355,44.799,85.548,44.799z"></path>{' '}
            </g>{' '}
          </g>{' '}
        </g>{' '}
      </g>
...
export function SepLinkIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function SepChartBarIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className={props.className ?? "h-5 w-5"}
      fill="none"
...
export function SepDocumentTextIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className={props.className ?? "h-5 w-5"}
      fill="none"
...
export function SepAcademicCapIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      className={props.className ?? "h-5 w-5"}
      fill="none"
...
export function SepDashboardIcon() {
  return (
...
export function SepChevronIcon() {
  return (
    <svg
      aria-hidden="true"
      fill="currentColor"

...
specs = [
  ('Ir al centro de acopio a entregar insumos', 'ayuda',
  ...
  ('Ordenar y clasificar insumos en centro de acopio', 'microvoluntariado',
  ...
  ('Apoyo en la universidad: acompanamiento a estudiantes', 'educacion',
  ...
  ('Recreacion con ninos en albergue temporal', 'salud',
  ...
  ('Reciclaje de desperdicios en centros de acopio', 'limpieza',
...
db.add(Activity(title='Campana de recoleccion de libros', description='Recoleccion de libros para la biblioteca comunitaria.',
                zone='educacion', raw_address='Calle Serrano 50, Valparaiso',

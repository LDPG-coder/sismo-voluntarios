...
class Activity(Base, IdMixin, TimestampMixin, TenantMixin):
    ...
    # cualquier tipo (interna/registro previo): se deriva de la
    # diferencia end_time - date_time, o de estimated_duration_min.
    # Ver _compute_realized_hours().
    ...
    # de AVAA que SUMAN horas al programa.
...
def _compute_realized_hours(a: "Activity") -> float | None:
    ...
    Devuelve None solo si no hay ninguna fuente.
    """
